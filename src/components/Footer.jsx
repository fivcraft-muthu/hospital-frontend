    ...
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <img src="/logo.png" alt="Shanthi Nikethan Logo" className="h-9 w-9 object-contain rounded-lg bg-white p-0.5" />
              <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Providing compassionate and professional healthcare services to Shenkottai and surrounding regions since inception. Your well-being is our ultimate commitment.
            </p>
            <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
              <span className="text-xs text-secondary font-bold uppercase tracking-wider block mb-1">Emergency Service</span>
              <a href="tel:04633233103" className="flex items-center space-x-2 text-white hover:text-secondary font-bold text-lg">
          ...
          {/* Working Hours */}
          <div className="lg:mx-auto w-full max-w-[280px]">
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              ...
              <li className="flex justify-between border-b border-slate-800 pb-2">
                <span>Laboratory & Pharmacy:</span>
                <span className="text-secondary font-medium">24 / 7 Available</span>
              </li>
              <li className="flex justify-between border-b border-slate-800 pb-2">
                <span>Emergency Ward:</span>
                <span className="text-red-400 font-medium">24 Hours Open</span>
              </li>
              <li className="flex justify-between">
                <span>Visiting Hours (IP):</span>
          ...
          {/* Contact Details */}
          <div className="lg:ml-auto w-full max-w-[280px]">
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:04633233103" className="hover:text-white transition-colors duration-200">
                  04633 233 103
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <FaEnvelope className="text-secondary flex-shrink-0" />
                <a href="mailto:info@shanthinikethan.com" className="hover:text-white transition-colors duration-200">
        ...
        <div className="mt-16 pt-8 border-t border-slate-800 text-center flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
          <p>&copy; {currentYear} Shanthi Nikethan Nursing Home. All rights reserved.</p>
